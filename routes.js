...
const categoryReistration = React.lazy(() =>import ('./registration/cateoryRegistation/category'))
const itemRegistration = React.lazy(() =>import ('./registration/ItemRegistration/item'))
const purchaseRegistration = React.lazy(() =>import ('./registration/purchaseRegistration/purchase'))
const userRegistration = React.lazy(() =>import ('./registration/userRegistration/user'))
const paymentRegistration = React.lazy(() =>import ('./registration/paymentRegistration/payment'))    
const purchaseRecieve = React.lazy(() =>import ('./registration/purchaseRecieve/purchaseReceive'))  
const orderSend = React.lazy(() =>import ('./registration/orderSend/order'))  
const vendorRegistration = React.lazy(() =>import ('./registration/vendorRegistration/vendor')) 
const customerRegistration = React.lazy(() =>import ('./registration/customerRegistration/customer')) 
...
const Progress = React.lazy(() =>
    import ('./views/base/progress/Progress'))
const Spinners = React.lazy(() =>
    import ('./views/base/spinners/Spinners'))
...
const routes = [
    ...
    { path: '/registration/categoryReistration', name: 'Category', element: categoryReistration },
    { path: '/registration/itemRegistration', name: 'Item', element: itemRegistration },
    { path: '/registration/purchaseRegistration', name: 'Purchase', element: purchaseRegistration },
    { path: '/registration/userRegistration', name: 'User', element: userRegistration },
    { path: '/registration/paymentRegistration', name: 'Payment', element: paymentRegistration },
    { path: '/registration/purchaseRecieve', name: 'Payment', element: purchaseRecieve },
    { path: '/registration/orderSend', name: 'Order', element: orderSend },
    { path: '/registration/vendorRegistration', name: 'Vendor', element: vendorRegistration },
    { path: '/registration/customerRegistration', name: 'Customer', element: customerRegistration },
]
